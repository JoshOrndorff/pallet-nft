...
pub trait UniqueAssets<AccountId, AssetId, AssetInfo> {
    ...
    fn assets_for_account(account: &AccountId) -> Vec<(AssetId, AssetInfo)>;
    /// The ID of the account that owns an asset.
    fn owner_of(asset_id: &AssetId) -> AccountId;
